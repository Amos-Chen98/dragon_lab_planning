...
class PoseTransformer:
    ...
    def transform_pose(self):
        self.ef_pose_in_hand.header.stamp = self.world2hand_tf.header.stamp  # Use The same timestamp as the hand frame

        try:
            ef_pose_in_world = self.tf_buffer.transform(self.ef_pose_in_hand, "world", rospy.Duration(0.5))  # waiting fot TF timeout of 0.5 seconds
